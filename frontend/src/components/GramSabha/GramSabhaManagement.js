  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      formDataToSend.append(
        ...
        formData.scheduledDurationMinutes
      );
      ...
      if (selectedGramSabha) {
        response = await updateGramSabhaMeeting(
          selectedGramSabha._id,
          formDataToSend
        );
      } else {
              ...
              {gramSabhas.length === 0 ? (
                ...
                gramSabhas.map((gramSabha) => (
                  <TableRow key={gramSabha._id}>
                    ...
                    <TableCell>
                      {gramSabha.scheduledDurationMinutes} minutes
                    </TableCell>
      ...
      >
        ...
        <DialogActions>
          ...
          <Button
            ...
            color="primary"
            disabled={
              loading || !formData.date || !formData.time || !formData.agenda
            }
          >
